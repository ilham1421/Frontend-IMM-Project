    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="h-48 bg-imm-gray rounded-xl flex items-center justify-center text-imm-gray-dark text-sm mb-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-medium">{((totalVerifikasi / totalAll) * 100).toFixed(1)}%</span>
            </div>
            <div className="flex items-center justify-between text-sm">
              <div className="flex items-center gap-2">
              ...
              <span className="font-medium">{((totalMenunggu / totalAll) * 100).toFixed(1)}%</span>
            </div>
            <div className="flex items-center justify-between text-sm">
              <div className="flex items-center gap-2">
              ...
              <span className="font-medium">{((totalDitolak / totalAll) * 100).toFixed(1)}%</span>
            </div>
          </div>
        </div>
      </div>
